...
function setup_survivor(namespace, identifier, name, description, end_quote,
    ...
    survivor.primary_color = colour -- for stats screen
...
local function setup_sprites(self)
    ...
    self.sprite_jump        = survivors[self.class].walk_sprite
    self.sprite_jump_peak   = survivors[self.class].walk_sprite
    self.sprite_fall        = survivors[self.class].walk_sprite
